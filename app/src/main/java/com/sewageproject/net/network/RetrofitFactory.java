...
public class RetrofitFactory {
    ...
    public static String BASE_URL = MyApplication.HTTP_BASE_URL;
...
//                requestBuilder.addHeader("myToken", BaseConstant.TOKEN == null ? "" : BaseConstant.TOKEN);//添加请求头信息，服务器进行token有效性验证
//                requestBuilder.addHeader("version", BaseApp.VersionName);//添加请求头信息，服务器进行ID有效性验证
...
//        }
        ...
        okHttpBuilder.connectionPool(new ConnectionPool(32, 5, TimeUnit.MINUTES));
        //错误重连
